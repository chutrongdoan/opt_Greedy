...
vehicle = read_xlsx('data_anh_Son/VRPTW_data_sample_vehicle_list.xlsx')
### constant
...
for i in range(len(vehicle)):
    vehicle_now = Vihicle(data['vehicle_id'][i], data['capacity'][i], data['start_point_id'][i])
    vehicle.append(vehicle_now)
